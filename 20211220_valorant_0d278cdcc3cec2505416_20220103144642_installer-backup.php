...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211220_valorant_0d278cdcc3cec2505416_20220103144642_archive.zip';
	const ARCHIVE_SIZE		 = '56510824';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0d278cd-03144642';
    const SECONDARY_PACKAGE_HASH = '90df630-03144642';
	const VERSION			 = '1.4.3';
